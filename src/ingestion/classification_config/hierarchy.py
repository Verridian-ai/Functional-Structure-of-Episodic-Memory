...
HIERARCHY_MAP: dict[str, HierarchyEntry] = {
    ...
    "FamCAFC": {
        "jurisdiction": "CTH",
        "court": "Family Court (Appeal)",
        "weight": 8,
        "type": "Case",
    },
    "FedCFamC1A": {
        "jurisdiction": "CTH",
        "court": "Federal Circuit and Family Court (Div 1 Appeal)",
        "weight": 8,
        "type": "Case",
    },
    "FedCFamC1F": {
        "jurisdiction": "CTH",
        "court": "Federal Circuit and Family Court (Div 1)",
        "weight": 6,
        "type": "Case",
    },
    "FedCFamC2F": {
    ...
    "AATA": {
        "jurisdiction": "CTH",
        "court": "Admin Appeals Tribunal",
        "weight": 4,
        "type": "Tribunal",
    },
    "ART": {
        "jurisdiction": "CTH",
        "court": "Admin Review Tribunal",
        "weight": 4,
        "type": "Tribunal",
    },
    "FWCFB": {
    ...
    "NSWLEC": {
        "jurisdiction": "NSW",
        "court": "Land and Environment Court",
        "weight": 5,
        "type": "Case",
    },
    "NSWIRC": {
    ...
    "ACAT": {
        "jurisdiction": "ACT",
        "court": "ACT Civil and Admin Tribunal",
        "weight": 3,
        "type": "Tribunal",
    },
    # ==========================================================================
