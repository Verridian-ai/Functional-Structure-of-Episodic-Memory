...
EMPLOYMENT_KEYWORDS = {
    ...
    "Emp_General_Protections": [
        ...
        "benefit derived from industrial instrument",
        ...
        "FWC general protections jurisdiction",
        "Federal Court general protections",
        "Federal Circuit Court general protections",
        # Coercion and undue influence
        "coercion",
        "undue influence",
        "undue pressure",
        "duress",
        "misrepresentation about workplace rights",
    ...
    "Emp_Industrial_Action": [
        ...
        "written notice",
        "notice of employee claim action",
        ...
        "valid ballot",
        # FWC powers
        "suspend protected industrial action",
        ...
        "contract immunity",
        "no loss of pay",
        "payment during protected action",
        "partial work bans",
        "s470",
        "s471",
        "s472",
        ...
        "injunction industrial action",
        "penalty for unprotected action",
    ...
    "Emp_Awards_Agreements": [
        ...
        "MA000016",
        "Vehicle Manufacturing, Repair, Services Award",
        "MA000089",
        "Meat Industry Award",
        "MA000059",
        "Horticulture Award",
        ...
        "nominal expiry date",
        "zombie agreement",
        "post-nominal expiry date agreement",
        ...
        "variation to remove ambiguity",
        # Greenfields agreements
        "greenfields agreement",
        "s182",
        "pre-operational agreement",
        "new enterprise",
    ...
    "Emp_Wages_Entitlements": [
        ...
        "reasonable request to work",
        "refusing to work public holiday",
    ...
    "Emp_Discrimination": [
        ...
        "Federal Court discrimination",
        "Federal Circuit Court discrimination",
        "state tribunal",
...
print(
    f"Employment Law Module: {_total_keywords} keywords loaded across {len(EMPLOYMENT_KEYWORDS)} subcategories"
)
