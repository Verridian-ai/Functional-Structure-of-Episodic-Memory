...
class GSWExtractionQueue:
    ...
    def __init__(
        self, min_authority: int = DEFAULT_MIN_AUTHORITY, checkpoint_path: Path | None = None
    ):
        """
    ...
    def add(self, doc: dict[str, Any], priority: int | None = None) -> bool:
        """
    ...
    def _load_checkpoint(self) -> None:
        ...
        try:
            ...
            print(
                f"[Queue] Checkpoint loaded: {self.checkpoint.total_processed} previously processed"
            )
