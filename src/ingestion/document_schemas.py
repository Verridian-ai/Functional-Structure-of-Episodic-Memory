...
class Part(BaseModel):
    ...
    number: str
    title: str
    heading_type: HeadingType | None = None
...
class Headnote(BaseModel):
    ...
    held: str
    arguments: dict[str, list[str]] | None = None  # CLR only
...
class CaseCited(BaseModel):
    ...
    citation: str
    treatment: CaseTreatment | None = None
...
class JudgmentParagraph(BaseModel):
    ...
    number: int
    judge: str | None = None  # For multi-judge decisions
    text: str
...
class CaseLawDocument(BaseModel):
    ...
    headnote: Headnote | None = None
    appearances: Appearances | None = None
    ...
    def get_paragraph(self, number: int) -> JudgmentParagraph | None:
...
class EnablingAct(BaseModel):
    ...
    title: str
    section: str | None = None  # Authority section
...
class ExplanatoryMemorandum(BaseModel):
    ...
    compatibility_statements: CompatibilityStatement | None = None
...
class SecondReadingSpeech(BaseModel):
    ...
    date: str | None = None
    hansard_reference: str | None = None
...
class BillDocument(BaseModel):
    ...
    explanatory_memorandum: ExplanatoryMemorandum | None = None
    second_reading_speech: SecondReadingSpeech | None = None
...
def extract_court_code(citation: str) -> str | None:
    """
...
def extract_year_from_mnc(citation: str) -> int | None:
    """
...
def parse_section_reference(ref: str) -> dict[str, str | None]:
    """
    ...
    """
    result = {"section": None, "subsection": None, "paragraph": None, "subparagraph": None}
