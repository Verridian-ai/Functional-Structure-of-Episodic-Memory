...
from src.logic.gsw_schema import LegalCase
...
class ContradictionDetector:
    ...
    def detect_contradictions(
        self, cases: list[LegalCase], threshold: float = 0.4
        ...
        for case in cases:
            ...
            order_states = [
                s for a in case.workspace.actors.values() for s in a.states if "Order" in s.name
            ]
            if order_states:
            ...
            vectors.append({"id": case.case_id, "facts": fact_vec, "outcome": outcome_vec})
