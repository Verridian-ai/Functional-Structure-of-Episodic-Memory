...
class AnalogyEngine:
    ...
    def calculate_transformation(
        self, case_a: GlobalWorkspace, case_b: GlobalWorkspace
    ) -> torch.Tensor:
        """
    ...
    def solve_analogy(
        ...
        candidates: list[GlobalWorkspace],
    ) -> tuple[GlobalWorkspace | None, float]:
        """
        Solves A : B :: C : ?
    ...
    def find_structural_analogies(
        self, query_case: GlobalWorkspace, knowledge_base: list[GlobalWorkspace]
    ) -> list[tuple[GlobalWorkspace, float]]:
        """
