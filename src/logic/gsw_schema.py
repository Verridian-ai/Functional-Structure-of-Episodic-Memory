...
class State(BaseModel):
    ...
    start_date: str | None = None  # When state began (ISO format or fuzzy)
    end_date: str | None = None  # When state ended (None if current)
...
class VerbPhrase(BaseModel):
    ...
    agent_id: str | None = None  # Who performed the action
    patient_ids: list[str] = Field(default_factory=list)  # Who/what was affected
    temporal_id: str | None = None  # When (link to temporal entity)
    spatial_id: str | None = None  # Where (link to location entity)
...
class PredictiveQuestion(BaseModel):
    ...
    target_entity_id: str | None = None  # Which entity this question is about
    answerable: bool = False
    answer_text: str | None = None
    answer_entity_id: str | None = None  # Entity that IS the answer
    source_chunk_id: str = ""  # Where question was generated
    answered_in_chunk_id: str | None = None  # Where answer was found
    metadata: dict[str, Any] = Field(default_factory=dict)
...
class SpatioTemporalLink(BaseModel):
    ...
    tag_type: LinkType
    tag_value: str | None = None  # The actual date/location if known
    source_chunk_id: str = ""
    metadata: dict[str, Any] = Field(default_factory=dict)
...
class Actor(BaseModel):
    ...
    def get_current_state(self, state_name: str) -> State | None:
