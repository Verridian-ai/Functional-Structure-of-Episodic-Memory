  ...
  const modalContent = (
    ...
    >
      ...
      >
        ...
        <button
          onClick={handleSkip}
          className="absolute top-3 right-3 sm:top-4 sm:right-4 p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-xl text-zinc-500 hover:text-zinc-300 active:text-zinc-300 hover:bg-white/10 active:bg-white/10 transition-all z-10 touch-manipulation"
        ...
        <div className="relative p-5 sm:p-8 md:p-10">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base md:text-lg text-zinc-400 max-w-md mx-auto px-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
            {features.map((feature, index) => (
              <div
                key={feature.title}
                className={`
                  group p-4 sm:p-5 rounded-xl sm:rounded-2xl transition-all duration-300
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            <button
              ...
              className="group w-full sm:w-auto flex items-center justify-center gap-2 sm:gap-3 px-6 sm:px-8 py-3.5 sm:py-4 min-h-[48px] rounded-xl sm:rounded-2xl text-black font-semibold transition-all hover:scale-[1.02] active:scale-[0.98] touch-manipulation"
              style={{
            ...
            <button
              onClick={handleSkip}
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 sm:px-6 py-3 sm:py-4 min-h-[44px] rounded-xl sm:rounded-2xl text-zinc-400 hover:text-white active:text-white transition-colors hover:bg-white/5 active:bg-white/10 touch-manipulation"
            >
              <Zap className="w-4 h-4 flex-shrink-0" />
              <span className="text-sm sm:text-base">Skip, I know what I&apos;m doing</span>
            </button>
          </div>

          {/* Keyboard hint - Hidden on mobile */}
          <p className="hidden sm:block text-center text-xs text-zinc-600 mt-6">
